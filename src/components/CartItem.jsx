...
function MyButton(props) {
  return (
    <button className="w-[17px] md:w-[29px] h-[17px] md:h-[29px] flex items-center justify-center border-[1px] border-primary-red lg:rounded-[5px]">
      {props.text}
    </button>
  );
}
      ...
      <div className="h-[46px] md:h-[75px] flex justify-between font-Poppins mt-[20px]">
        <div className="flex gap-[14px] sm:gap-8 w-[210px] md:w-[400px]">
          ...
          <div className="w-[57px] md:w-[133px] h-[46px] md:h-[75px] border">
            <img src={itemImage} alt="" className="w-[57px] h-[46px] sm:w-[133px] sm:h-[75px]" />
          </div>
          <div className="flex flex-col justify-between">
            <p className="text-[10px] md:text-[16px] text-primary-grey font-semibold">
              {itemName}
            </p>
