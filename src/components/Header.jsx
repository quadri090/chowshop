...
export default function Header() {
  ...
  return (
    <div className='w-screen fixed top-0 h-[48px] sm:h-[60px] px-[20px] sm:px-[30px] lg:px-[100px] mb-[22px] lg:mb-[42px] flex justify-between items-center bg-white text-[12px] sm:text-[16px] font-normal font-Poppins leading-normal'>
