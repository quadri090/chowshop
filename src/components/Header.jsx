...
export default function Header() {
  ...
  return (
    <div className="w-screen fixed top-0 h-[48px] sm:h-[60px] px-[20px] sm:px-[30px] lg:px-[100px] mb-[22px] lg:mb-[42px] flex justify-between items-center bg-white text-[12px] sm:text-[16px] font-normal font-Poppins z-10 leading-normal">
      ...
      <ul className="flex items-center justify-center gap-[20px] sm:gap-[30px] lg:gap-[50px]">
        ...
        <li
          className={` w-[74px] sm:w-[92px] h-[32px] sm:h-[40px] flex items-center justify-center rounded-[5px] text-primary-red font-medium border border-primary-red`}
          onClick={() => {
            isVisible();
          }}
        >
