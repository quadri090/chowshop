...
export default function LogIn() {
  ...
  return (
    <div className="sm:w-[500px] lg:w-[90%] sm:flex flex-col justify-center  my-[40px] lg:my-[80px] mx-[20px] sm:mx-auto font-Poppins">
      <div className="flex items-center justify-between">
        ...
        <Link to="/">
          <div className="w-[25px] sm:w-[40px] h-[25px] sm:h-[40px] flex items-center justify-center border shadow-myBoxShadow bg-[#fff] rounded-full text-primary-red">
            <i
              className="fa fa-times text-[16px] md:text-[24px] font-extralight"
              onClick={() => {
                isNotVisible();
              }}
            ></i>
      ...
      <div>
        <div
          className="w-full sm:w-[500px] lg:w-full h-[50px] sm:h-[60px] mt-[40px] flex items-center justify-center gap-[15px] rounded-[5px] sm:mx-auto bg-black text-white text-[14px] "
          onClick={() => {
        ...
        <div className="mt-[20px]">
          <InputArea
            ...
            inputprops="w-full h-[50px] sm:h-[60px] shadow-xl"
          />
        </div>
